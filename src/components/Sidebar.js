    ...
    <div className="sidebar">
      ...
      <nav className="sidebar-nav">
        ...
        <div className={`nav-item${location.pathname === '/mycourse' ? ' active' : ''}`} onClick={() => navigate('/mycourse') }>
          ...
          <svg width="28" height="28" viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M4.66667 22.75C4.66667 21.9765 4.97396 21.2346 5.52094 20.6876C6.06792 20.1407 6.80979 19.8334 7.58333 19.8334H23.3333M4.66667 22.75C4.66667 23.5236 4.97396 24.2655 5.52094 24.8124C6.06792 25.3594 6.80979 25.6667 7.58333 25.6667H23.3333V2.33337H7.58333C6.80979 2.33337 6.06792 2.64066 5.52094 3.18765C4.97396 3.73463 4.66667 4.47649 4.66667 5.25004V22.75Z" stroke="#373A3D" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
</svg>
        ...
        <div className={`nav-item${location.pathname === '/quiz-builder' ? ' active' : ''}`} onClick={() => navigate('/quiz-builder') }>
          ...
          <path d="M21 18.6637L19.8888 19.9417C19.2994 20.6193 18.5002 21 17.6668 21C16.8335 21 16.0342 20.6193 15.4449 19.9417C14.8547 19.2655 14.0555 18.8857 13.2224 18.8857C12.3893 18.8857 11.5902 19.2655 11 19.9417M1 21H2.86061C3.40414 21 3.67591 21 3.93166 20.9354C4.15841 20.8782 4.37517 20.7838 4.574 20.6557C4.79826 20.5112 4.99043 20.3092 5.37477 19.9051L19.3334 5.23019C20.2539 4.26247 20.2539 2.6935 19.3334 1.72578C18.4129 0.758071 16.9205 0.758072 16 1.72578L2.0414 16.4007C1.65706 16.8048 1.46489 17.0068 1.32747 17.2426C1.20563 17.4516 1.11584 17.6795 1.0614 17.9179C1 18.1868 1 18.4725 1 19.0439V21Z" stroke="#373A3D" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
          </svg>
